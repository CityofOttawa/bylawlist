( function(CKEDITOR) {
  CKEDITOR.plugins.add( 'bylawlist', {
    onLoad: function() {
      CKEDITOR.addCss(
        'ol.bylawlist{list-style-position:inside;list-style-type:none;padding-left:1.5em}ol.bylawlist li{counter-increment:bylawlist-counter;margin-bottom:1em}ol.bylawlist li:first-child{margin-top:1em}ol.bylawlist li ol{counter-reset:bylawlist-counter}ol.bylawlist>li:first-child{margin-top:0}ol.bylawlist>li:before{content:"(" counter(bylawlist-counter,decimal) ") ";margin-left:-1.45em}ol.bylawlist>li>ol{list-style-type:inherit}ol.bylawlist>li>ol>li:before{content:"(" counter(bylawlist-counter,lower-alpha) ") ";margin-left:-1.45em}ol.bylawlist>li>ol>li>ol{list-style-type:inherit}ol.bylawlist>li>ol>li>ol>li:before{content:"(" counter(bylawlist-counter,lower-roman) ") ";margin-left:-1.45em}ol.bylawlist>li>ol>li>ol>li>ol{list-style-type:inherit}ol.bylawlist>li>ol>li>ol>li>ol>li:before{content:counter(bylawlist-counter,decimal) ". ";margin-left:-1.1em}ol.bylawlist>li>ol>li>ol>li>ol ol{list-style-type:inherit}ol.bylawlist>li>ol>li>ol>li>ol ol>li:before{content:counter(bylawlist-counter,upper-alpha) ". ";margin-left:-1.1em}'
      );
    },
